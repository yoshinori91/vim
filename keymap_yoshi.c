...
{KC_LALT, KC_Z,    KC_X,    KC_C,         KC_V,         KC_B,          KC_N,    KC_M,         KC_COMM,       KC_DOT,  KC_SLSH, KC_TAB},
{KC_DEL,  KC_LCTL, KC_LALT, OSM(MOD_LALT),LT(1,KC_ESC), SFT_T(KC_SPC), _______, LT(2,KC_TAB), OSM(MOD_LGUI), KC_LGUI, _______, KC_GRV}
},
[1] = {
{_______, _______, KC_AMPR, KC_ASTR, KC_PIPE, _______, _______, KC_7, KC_8,    KC_9,    KC_GRV,  _______},
{_______, _______, KC_DLR,  KC_PERC, KC_CIRC, _______, _______, KC_4, KC_5,    KC_6,    KC_TILD, _______},
...
[3] = {
{_______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,  _______, _______},
{_______, _______, _______, _______, _______, _______, LCTL(LSFT(KC_Z)), KC_QUOT, KC_DQUO, KC_COLN,  KC_SCLN, _______},
{_______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,  _______, _______},
{_______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,  _______, _______}
}
};
