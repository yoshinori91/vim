...
[0] = {
  ...
  {LT(3,KC_SCLN),KC_A,   KC_S,   KC_D,         KC_F,         KC_G,         KC_H,   KC_J,         KC_K,         KC_L,   OSM(MOD_LCTL),KC_ENT,},
...
[2] = {
  ...
  {_______, KC_COLN,KC_LBRC, KC_LCBR, KC_LPRN, KC_SCLN, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_HOME, KC_END},
