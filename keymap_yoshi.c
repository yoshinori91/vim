...
{OSL(3),  KC_A,    KC_S,    KC_D,         KC_F,         KC_G,          KC_H,    KC_J,          KC_K,          KC_L,    KC_ESC,  CTL_T(KC_ENT)},
...
{RESET,   _______, _______, _______, _______, KC_BSPC, _______, _______,   _______,    _______, _______, _______}
},
[2] = {
...
{_______, _______, _______, _______, _______, _______, LCTL(LALT(KC_LEFT)), _______, _______, LCTL(LALT(KC_RGHT)), _______, _______},
{_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
