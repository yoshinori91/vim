...
[QWERTY_LAYER] = { /* Qwerty */
  ...
  {FUNC(5), KC_A,   KC_S,    KC_D,    KC_F,    KC_G,          KC_H,   KC_J,    KC_K,      KC_L,     KC_SCLN,  CTL_T(KC_ENT)},
  {FUNC(1), KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,          KC_N,   KC_M,    KC_COMMA,  KC_DOT,   KC_SLSH,  FUNC(4)},
  {KC_LCTL, KC_ESC, KC_LGUI, KC_LALT, FUNC(1), SFT_T(KC_SPC), KC_TRNS ,FUNC(2),KC_TRNS,   KC_TRNS,  KC_BTN2, KC_BTN1}
},
[LOWER_LAYER] = { /* LOWER */
...
[UPPER_LAYER] = { /* RAISE */
  {KC_TRNS,   KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC,    KC_TRNS, KC_RPRN, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS},
  {KC_MINS,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR,    KC_EQL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_HOME, KC_END},
...
[FN1_LAYER] = {
  ...
  {KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  S(KC_4),  S(KC_5),  S(KC_6),  S(KC_9), S(KC_0)},
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [4] = ACTION_LAYER_TAP_KEY(F_LAYER, KC_BTN2),
    [5] = ACTION_LAYER_TAP_KEY(FN1_LAYER, KC_P),
